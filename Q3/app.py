...
with tab1:
    ...
    if uploaded_file is not None:
        if not db:
            ...
            tmp_path = None
            try:
                # ✅ FIX 1: use getvalue() instead of read() so repeated
                # Streamlit reruns don't get an empty buffer
                ...
                # ✅ FIX 2: guard against tmp_path never being set
            ...
            with st.spinner("Processing batch archive..."):
                with tempfile.TemporaryDirectory() as tmp_dir:
                    ...
                    with open(zip_path, "wb") as zf:
                        zf.write(zip_file.getvalue())  # ✅ getvalue() here too
                    ...
                    if not audio_files:
                        ...
                        st.dataframe(df, use_container_width=True)  # ✅ FIX 3: removed undefined `stretch`
